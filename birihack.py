...
# ----------------- Password Protection -----------------
PASSWORD = "SAMIR"  # নির্দিষ্ট পাসওয়ার্ড

def authenticate():
    print("\033[1;93m[!] Secure Script Locked. Password Required.\033[0m")
    while True:
        try:
            pwd = input("Enter Password to Run: ")
            if pwd == PASSWORD:
                print("\033[1;92m[+] Access Granted! Starting...\033[0m")
                break
            else:
                print("\033[1;91m[-] Incorrect Password! Try again.\033[0m")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='OneShotPin 0.0.2 (c) 2017 rofl0r, modded by SAMIR',
